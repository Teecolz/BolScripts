		...
		if not spiderForm then
			if skills.E.ready and ValidTarget(target, skills.E.range) and Menu.Harass.useE then
				if VIP_USER and Menu.Ads.VIP.prodiction then
					...
					local ePosition, eChance = VP:GetCircularCastPosition(target, skills.E.delay, skills.E.width, skills.E.range, skills.E.speed, myHero, true)
			...
			if skills.W.ready and ValidTarget(target, skills.W.range) and Menu.Harass.useW then
				if VIP_USER and Menu.Ads.VIP.prodiction then
					...
					local Position, Chance = VP:GetCircularCastPosition(target, skills.W.delay, skills.W.width, skills.W.range, skills.W.speed, myHero, false)
